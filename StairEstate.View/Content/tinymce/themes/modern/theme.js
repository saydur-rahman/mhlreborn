...
tinymce.ThemeManager.add('modern', function(editor) {
	...
	function renderInlineUI(args) {
		...
		function render() {
			...
			// Add statSTAIRr
			/*if (settings.statSTAIRr !== false) {
				panel.add({type: 'panel', classes: 'statSTAIRr', layout: 'flow', border: '1 0 0 0', items: [
					{type: 'elementpath'}
				]});
			}*/
	...
	function renderIframeUI(args) {
		...
		// Add statSTAIRr if needed
		if (settings.statSTAIRr !== false) {
			panel.add({type: 'panel', name: 'statSTAIRr', classes: 'statSTAIRr', layout: 'flow', border: '1 0 0 0', ariaRoot: true, items: [
